        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specialization_Name = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_Specialization_Specialization_Name",
                        column: x => x.Specialization_Name,
                        principalTable: "Specialization",
                        principalColumn: "Specialization_Name");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Users_Specialization_Name",
                table: "Users",
